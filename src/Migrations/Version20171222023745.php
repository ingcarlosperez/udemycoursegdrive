 ...
 */
class Version20171222023745 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, description VARCHAR(100) NOT NULL, name VARCHAR(255) NOT NULL, fileid VARCHAR(255) NOT NULL, INDEX IDX_D8698A76217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
